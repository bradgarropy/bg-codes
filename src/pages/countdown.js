        ...
        <>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full grid grid-cols-[40fr_60fr] items-center">
                <div className="grid justify-items-center">
                    ...
                    <span className="uppercase text-[12.5rem] bg-white py-0 px-16 -skew-x-3 -skew-y-3">
                        codes
                    </span>
                </div>

                <div>
                    <h1 className="mb-8 text-[14rem] text-white drop-shadow-[black_0.75rem_0.75rem_0rem] uppercase">
                        starting soon
                    </h1>
